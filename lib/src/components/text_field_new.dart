...
///TltTextSelectionControls
///TltTextSelectionGestureDetectorBuilder
...
import 'package:tlt_design/src/components/input_decorator.dart';
import 'package:tlt_design/src/components/text_selection.dart';
...
typedef InputCounterWidgetBuilder = Widget? Function(
  ...
  /// The maximum string length that can be entered into the TltNewTextField.
  required int? maxLength,

  /// Whether or not the TltNewTextField is currently focused. Mainly provided for
  /// the [liveRegion] parameter in the [Semantics] widget for accessibility.
  required bool isFocused,
});

class _TltNewTextFieldSelectionGestureDetectorBuilder
    extends TltTextSelectionGestureDetectorBuilder {
  _TltNewTextFieldSelectionGestureDetectorBuilder({
    required _TltNewTextFieldState state,
  })  : _state = state,
        super(delegate: state);

  final _TltNewTextFieldState _state;
...
///
/// {@tool dartpad}
/// This example shows how to create a [TltNewTextField] that will obscure input. The
/// [ TltInputDecoration] surrounds the field in a border using [OutlineInputBorder]
/// and adds a label.
///
...
/// ## Reading values
///
/// A common way to read a value from a TltNewTextField is to use the [onSubmitted]
/// callback. This callback is applied to the text field's current value when
/// the user finishes editing.
///
/// {@tool dartpad}
/// This sample shows how to get a value from a TltNewTextField via the [onSubmitted]
/// callback.
///
...
/// callback.
///
/// Keep in mind you can also always read the current string from a TltNewTextField's
...
///  * [TltInputDecorator], which shows the labels and other visual elements that
///    surround the actual text editing widget.
///  * [EditableText], which is the raw text editing control at the heart of a
///    [TltNewTextField]. The [EditableText] widget is rarely used directly unless
...
class TltNewTextField extends StatefulWidget {
  ...
  /// [TltNewTextField.noMaxLength] then only the current length is displayed.
  ///
  ...
  TltNewTextField({
    ...
    this.magnifierConfiguration,
        ...
        assert(maxLength == null ||
            maxLength == TltNewTextField.noMaxLength ||
            maxLength > 0),
        ...
        assert(
          ...
          'Use keyboardType TextInputType.multiline when using TextInputAction.newline on a multiline TltNewTextField.',
        ),
        keyboardType = keyboardType ??
            (maxLines == 1 ? TextInputType.text : TextInputType.multiline),
        enableInteractiveSelection =
            enableInteractiveSelection ?? (!readOnly || !obscureText),
        decoration = decoration ?? TltInputDecoration();
  ...
  /// {@macro flutter.material.TltInputDecorator.textAlignVertical}
  ...
  /// to [TltNewTextField.noMaxLength] then only the current character count is displayed.
  ///
  /// After [maxLength] characters have been input, additional input
  /// is ignored, unless [maxLengthEnforcement] is set to
  /// [MaxLengthEnforcement.none].
  ...
  /// which is evaluated after the supplied [inputFormatters], if any.
  ///
  /// This value must be either null, [TltNewTextField.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [TltNewTextField.noMaxLength], then no limit will
  ...
  /// will switch to the [decoration]'s [ TltInputDecoration.errorStyle] when the
  /// limit is exceeded.
  ///
  ...
  /// [ TltInputDecoration.enabled] property.
  final bool? enabled;
  ...
  final TltTextSelectionControls? selectionControls;
  ...
  ///
  /// {@tool dartpad}
  /// This example shows how to use a `TltNewTextFieldTapRegion` to wrap a set of
  /// "spinner" buttons that increment and decrement a value in the [TltNewTextField]
  ...
  ///
  /// The [mouseCursor] is the only property of [TltNewTextField] that controls the
  /// appearance of the mouse pointer. All other properties related to "cursor"
  /// stand for the text cursor, which is usually a blinking vertical line at
  /// the editing position.
  final MouseCursor? mouseCursor;

  /// Callback that generates a custom [ TltInputDecoration.counter] widget.
  ///
  /// See [InputCounterWidgetBuilder] for an explanation of the passed in
  /// arguments. The returned widget will be placed below the line in place of
  /// the default widget built when [ TltInputDecoration.counterText] is specified.
  ///
  ...
  ///  * [CupertinoTltNewTextField.cupertinoMisspelledTextStyle], the style configured
  ...
  /// Default builder for [TltNewTextField]'s spell check suggestions toolbar.
  ///
  ...
  ///    parameter for which this is the default value for [TltNewTextField].
  ///  * [CupertinoTltNewTextField.defaultSpellCheckSuggestionsToolbarBuilder], which
  ///    is like this but specifies the default for [CupertinoTltNewTextField].
  @visibleForTesting
  ...
  static SpellCheckConfiguration inferAndroidSpellCheckConfiguration(
    ...
    return configuration.copyWith(
      misspelledTextStyle: configuration.misspelledTextStyle ??
          TltNewTextField.materialMisspelledTextStyle,
      spellCheckSuggestionsToolbarBuilder:
          configuration.spellCheckSuggestionsToolbarBuilder ??
              TltNewTextField.defaultSpellCheckSuggestionsToolbarBuilder,
    );
  }

  @override
  State<TltNewTextField> createState() => _TltNewTextFieldState();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<TltInputDecoration>(
        'decoration', decoration,
        defaultValue: TltInputDecoration()));
    ...
    properties.add(DiagnosticsProperty<TltTextSelectionControls>(
...
class _TltNewTextFieldState extends State<TltNewTextField>
    with RestorationMixin
    implements TltTextSelectionGestureDetectorBuilderDelegate, AutofillClient {
  ...
  late _TltNewTextFieldSelectionGestureDetectorBuilder
      _selectionGestureDetectorBuilder;

  // API for TltTextSelectionGestureDetectorBuilderDelegate.
  @override
  ...
  // End of API for TltTextSelectionGestureDetectorBuilderDelegate.
  ...
  TltInputDecoration _getEffectiveDecoration() {
    final MaterialLocalizations localizations =
        MaterialLocalizations.of(context);
    final ThemeData themeData = Theme.of(context);
    final TltInputDecoration effectiveDecoration =
        (widget.decoration ?? TltInputDecoration()).copyWith(
      // contentPadding: EdgeInsets.zero,
      hintText: widget.decoration!.addOnBefore != null
          ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void initState() {
    super.initState();
    _selectionGestureDetectorBuilder =
        _TltNewTextFieldSelectionGestureDetectorBuilder(state: this);
  ...
  @override
  void didUpdateWidget(TltNewTextField oldWidget) {
  ...
  TextInputConfiguration get textInputConfiguration {
    ...
    final AutofillConfiguration autofillConfiguration = autofillHints != null
        ? AutofillConfiguration(
            ...
            hintText: (widget.decoration ?? TltInputDecoration()).hintText,
          )
  ...
  Widget build(BuildContext context) {
    ...
    switch (defaultTargetPlatform) {
      ...
      case TargetPlatform.windows:
        spellCheckConfiguration =
            TltNewTextField.inferAndroidSpellCheckConfiguration(
          widget.spellCheckConfiguration,
        );
    }

    TltTextSelectionControls? textSelectionControls = widget.selectionControls;
    ...
    switch (theme.platform) {
      ...
      case TargetPlatform.macOS:
        ...
        handleDidGainAccessibilityFocus = () {
          // Automatically activate the TltNewTextField when it receives accessibility focus.
          if (!_effectiveFocusNode.hasFocus &&
    ...
    Widget child = RepaintBoundary(
      child: UnmanagedRestorationScope(
        ...
        child: EditableText(
          ...
          mouseCursor:
              MouseCursor.defer, // TltNewTextField will handle the cursor
                  ...
                  Container(
                    decoration: BoxDecoration(
                        border: Border(
                            right: BorderSide(
                                color: widget
                                    .decoration!.border!.borderSide.color))),
                    child: widget.decoration?.addOnBefore ?? const SizedBox(),
                  ),
...
// BEGIN GENERATED TOKEN PROPERTIES - TltNewTextField
...
// END GENERATED TOKEN PROPERTIES - TltNewTextField
