...
/// [TextSelectionHandleControls] into the [TltTextSelectionControls] subclass when
...
abstract class TltTextSelectionControls {
  ...
  /// on iOS [cupertinoTltTextSelectionControls] does not call [onTap] at all,
...
/// [MaterialTltTextSelectionControls] or creating a custom subclass of
/// [TltTextSelectionControls].
///
/// The [emptyTltTextSelectionControls] global variable has a
/// suitable instance of this class.
class EmptyTltTextSelectionControls extends TltTextSelectionControls {
  @override
...
/// [materialTltTextSelectionControls] or creating a custom subclass of
/// [TltTextSelectionControls].
final TltTextSelectionControls emptyTltTextSelectionControls =
    EmptyTltTextSelectionControls();
...
class SelectionOverlay {
  ...
  ///
  /// The [TltTextSelectionControls.buildHandle] implementation the text field
  /// uses decides where the handle's tap "hotspot" is, or whether the
  /// selection handle supports tap gestures at all. For instance,
  /// [MaterialTltTextSelectionControls] calls [onSelectionHandleTapped] when the
  /// selection handle's "knob" is tapped, while
  /// [CupertinoTltTextSelectionControls] builds a handle that's not sufficiently
  ...
  Widget _buildStartHandle(BuildContext context) {
    final Widget handle;
    final TltTextSelectionControls? selectionControls = this.selectionControls;
  ...
  // Build the toolbar via TltTextSelectionControls.
...
// TltTextSelectionControls.buildToolbar.
...
/// Delegate interface for the [TltTextSelectionGestureDetectorBuilder].
///
...
/// [TltTextSelectionGestureDetectorBuilder] to build a
...
///    text field.
abstract class TltTextSelectionGestureDetectorBuilderDelegate {
  /// [GlobalKey] to the [EditableText] for which the
  /// [TltTextSelectionGestureDetectorBuilder] will build a [TextSelectionGestureDetector].
...
/// [TltTextSelectionGestureDetectorBuilder] can change the behavior performed in
...
///
/// A [TltTextSelectionGestureDetectorBuilder] must be provided a
/// [TltTextSelectionGestureDetectorBuilderDelegate], from which information about
...
class TltTextSelectionGestureDetectorBuilder {
  /// Creates a [TltTextSelectionGestureDetectorBuilder].
  TltTextSelectionGestureDetectorBuilder({
    required this.delegate,
  });

  /// The delegate for this [TltTextSelectionGestureDetectorBuilder].
  ///
  ...
  /// [EditableText].
  @protected
  final TltTextSelectionGestureDetectorBuilderDelegate delegate;
  ...
  /// [TltTextSelectionGestureDetectorBuilderDelegate.selectionEnabled] is true
  ...
  /// [TltTextSelectionGestureDetectorBuilderDelegate.editableTextKey].
...
// TODO(justinmc): Deprecate this after TltTextSelectionControls.buildToolbar is
// deleted, when users should migrate back to TltTextSelectionControls.buildHandle.
// See https://github.com/flutter/flutter/pull/124262
/// [TltTextSelectionControls] that specifically do not manage the toolbar in order
/// to leave that to [EditableText.contextMenuBuilder].
mixin TextSelectionHandleControls on TltTextSelectionControls {
  @override
  Widget buildToolbar(
    BuildContext context,
    Rect globalEditableRegion,
