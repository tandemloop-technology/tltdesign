...
/// See also:
///
///  * [TltInputDecoration.floatingLabelBehavior] which defines the behavior for
///    [TltInputDecoration.label] or [TltInputDecoration.labelText].
...
/// See also:
///
///  * [TltInputDecoration.floatingLabelAlignment] which defines the alignment for
///    [TltInputDecoration.label] or [TltInputDecoration.labelText].
...
class FloatingLabelAlignment {
  ...
  /// Align the floating label on the leading edge of the [TltInputDecorator].
  ///
  ...
  /// Aligns the floating label to the center of an [TltInputDecorator].
...
// An analog of TltInputDecoration for the _Decorator widget.
@immutable
class _Decoration {
  const _Decoration({
...
class _RenderDecoration extends RenderBox
  ...
  RenderBox? get addOnBefore => childForSlot(_DecorationSlot.addOnBefore);
  RenderBox? get addOnAfter => childForSlot(_DecorationSlot.addOnAfter);
  ...
  Iterable<RenderBox> get children {
    return <RenderBox>[
      ...
      if (addOnAfter != null) addOnAfter!,
      if (addOnBefore != null) addOnBefore!,
    ];
  }
  ...
  double _layoutLineBox(RenderBox? box, BoxConstraints constraints) {
    ...
    assert(() {
      ...
      throw FlutterError.fromParts(<DiagnosticsNode>[
        ErrorSummary(
            "One of TltInputDecorator's children reported a negative baseline offset."),
        ErrorDescription(
  ...
  _RenderDecorationLayout _layout(BoxConstraints layoutConstraints) {
    assert(
      ...
      'An TltInputDecorator, which is typically created by a TextField, cannot '
      'have an unbounded width.\n'
      'This happens when the parent widget does not provide a finite width '
      'constraint. For example, if the TltInputDecorator is contained by a Row, '
      'then its width must be constrained. An Expanded widget or a SizedBox '
      'can be used to constrain the width of the TltInputDecorator or the '
    ...
    // Layout all the widgets used by TltInputDecorator
    ...
    final double inputWidth = math.max(
      ...
      constraints.maxWidth -
          (_boxSize(icon).width +
              ...
              (addOnBefore != null ? -_boxSize(suffix).width : 0) +
    ...
    boxToBaseline[addOnBefore] = _layoutLineBox(
      addOnBefore,
      contentConstraints.copyWith(
        maxWidth:
            math.max(0.0, contentConstraints.maxWidth - _boxSize(hint).width),
      ),
    );
    boxToBaseline[addOnAfter] = _layoutLineBox(addOnAfter, contentConstraints);
  ...
  ChildSemanticsConfigurationsResult _childSemanticsConfigurationDelegate(
    ...
    for (final SemanticsConfiguration childConfig in childConfigs) {
      if (childConfig
          .tagsChildrenWith(_TltInputDecoratorState._kPrefixSemanticsTag)) {
        prefixMergeGroup ??= <SemanticsConfiguration>[];
        prefixMergeGroup.add(childConfig);
      } else if (childConfig
          .tagsChildrenWith(_TltInputDecoratorState._kSuffixSemanticsTag)) {
...
class _Decorator
  ...
  Widget? childForSlot(_DecorationSlot slot) {
    switch (slot) {
      ...
      case _DecorationSlot.addOnAfter:
        return decoration.addOnAfter;
      case _DecorationSlot.addOnBefore:
        return decoration.addOnBefore;
...
///
/// [TltInputDecorator] displays the visual elements of a Material Design text
/// field around its input [child]. The visual elements themselves are defined
/// by an [TltInputDecoration] object and their layout and appearance depend
/// on the `baseStyle`, `textAlign`, `isFocused`, and `isEmpty` parameters.
///
/// [TextField] uses this widget to decorate its [EditableText] child.
///
/// [TltInputDecorator] can be used to create widgets that look and behave like a
...
class TltInputDecorator extends StatefulWidget {
  ...
  ///
  /// Null [TltInputDecoration] properties are initialized with the corresponding
  ...
  /// {@template flutter.material.TltInputDecorator.textAlignVertical}
  ...
  /// See also:
  ///
  ///  * [TltInputDecoration.hoverColor], which is also blended into the focus
  ...
  /// [TltInputDecoration.hoverColor] with [TltInputDecoration.fillColor] when
  /// true, and [TltInputDecoration.fillColor] when not.
  ///
  /// Defaults to false.
  final bool isHovering;
  ...
  @override
  State<TltInputDecorator> createState() => _TltInputDecoratorState();

  /// The RenderBox that defines this decorator's "container". That's the
  /// area which is filled if [TltInputDecoration.filled] is true. It's the area
  /// adjacent to [TltInputDecoration.icon] and above the widgets that contain
  /// [TltInputDecoration.helperText], [TltInputDecoration.errorText], and
  /// [TltInputDecoration.counterText].
  ///
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(DiagnosticsProperty<TltInputDecoration>('decoration', decoration));
...
class _TltInputDecoratorState extends State<TltInputDecorator>
    with TickerProviderStateMixin {
  ...
  static const SemanticsTag _kPrefixSemanticsTag =
      SemanticsTag('_TltInputDecoratorState.prefix');
  static const SemanticsTag _kSuffixSemanticsTag =
      SemanticsTag('_TltInputDecoratorState.suffix');
  ...
  TltInputDecoration? _effectiveDecoration;
  TltInputDecoration get decoration =>
      _effectiveDecoration ??= widget.decoration;
  ...
  @override
  void didUpdateWidget(TltInputDecorator old) {
    super.didUpdateWidget(old);
  ...
  Color _getFillColor(ThemeData themeData, TltInputDecorationTheme defaults) {
  ...
  Color _getIconColor(ThemeData themeData, TltInputDecorationTheme defaults) {
    return MaterialStateProperty.resolveAs(
  ...
  Color _getPrefixIconColor(
      ThemeData themeData, TltInputDecorationTheme defaults) {
    return MaterialStateProperty.resolveAs(
  ...
  Widget build(BuildContext context) {
    ...
    final TltInputDecorationTheme defaults = Theme.of(context).useMaterial3
        ? _TltInputDecoratorDefaultsM3(context)
        : _TltInputDecoratorDefaultsM2(context);
    ...
    final _Decorator decorator = _Decorator(
      decoration: _Decoration(
          addOnAfter: decoration.addOnAfter,
          addOnBefore: decoration.addOnBefore,
...
/// Design text field.
///
/// The [TextField] and [TltInputDecorator] classes use [TltInputDecoration] objects
/// to describe their decoration. (In fact, this class is merely the
/// configuration of an [TltInputDecorator], which does all the heavy lifting.)
///
/// {@tool dartpad}
/// This sample shows how to style a `TextField` using an `TltInputDecorator`. The
...
/// `TltInputDecorator`. The collapsed `TextField` surrounds the hint text and
...
/// message, provide `errorText` to the [TltInputDecoration] constructor.
///
...
//   /// Defines an [TltInputDecorator] that is the same size as the input field.
//   ///
//   /// This type of input decoration does not include a border by default.
//   ///
//   /// Sets the [isCollapsed] property to true.
//   const TltInputDecoration.collapsed({
...
//   /// The style to use for [TltInputDecoration.labelText] when the label is on top
//   /// of the input field.
//   ///
...
//   /// if the [TextField] is focused or not.
//   ///
//   /// When the [TltInputDecoration.labelText] is above (i.e., vertically adjacent to)
...
//   /// of [TltInputDecoration] that changes the color of the label to the
//   /// [TltInputDecoration.errorStyle] color or [ColorScheme.error].
//   ///
//   /// {@tool dartpad}
...
//   /// The style to use for [TltInputDecoration.labelText] when the label is
//   /// above (i.e., vertically adjacent to) the input field.
//   ///
//   /// When the [TltInputDecoration.labelText] is on top of the input field, the
...
//   /// Text that provides context about the [TltInputDecorator.child]'s value, such
//   /// as how the value will be used.
//   ///
//   /// If non-null, the text is displayed below the [TltInputDecorator.child], in
...
//   ///
//   /// Displayed on top of the [TltInputDecorator.child] (i.e., at the same location
//   /// on the screen where text may be entered in the [TltInputDecorator.child])
...
//   /// top of the input field (i.e., at the same location on the screen where
//   /// text may be entered in the [TltInputDecorator.child]).
//   ///
//   /// If null, defaults to a value derived from the base [TextStyle] for the
//   /// input field and the current [Theme].
...
//   ///
//   /// If null, defaults to [TltInputDecorationTheme.hintFadeDuration].
//   /// If [TltInputDecorationTheme.hintFadeDuration] is null defaults to 20ms.
//   final Duration? hintFadeDuration;

//   /// Optional widget that appears below the [TltInputDecorator.child] and the border.
//   ///
...
//   /// Text that appears below the [TltInputDecorator.child] and the border.
//   ///
...
//   /// The style to use for the [TltInputDecoration.errorText].
//   ///
//   /// If null, defaults of a value derived from the base [TextStyle] for the
//   /// input field and the current [Theme].
//   ///
//   /// By default the color of style will be used by the label of
//   /// [TltInputDecoration] if [TltInputDecoration.errorText] is not null. See
//   /// [TltInputDecoration.labelStyle] or [TltInputDecoration.floatingLabelStyle] for
...
//   /// {@endtemplate}
//   ///
//   /// If null, [TltInputDecorationTheme.floatingLabelBehavior] will be used.
//   ///
//   /// See also:
//   ///
//   ///  * [floatingLabelAlignment] which defines **where** the floating label
...
//   /// {@endtemplate}
//   ///
//   /// If null, [TltInputDecorationTheme.floatingLabelAlignment] will be used.
//   ///
//   /// See also:
//   ///
//   ///  * [floatingLabelBehavior] which defines **how** the floating label should
...
//   /// Whether the [TltInputDecorator.child] is part of a dense form (i.e., uses less vertical
//   /// space).
//   ///
//   /// Defaults to false.
//   final bool? isDense;
...
//   ///
//   /// To create a collapsed input decoration, use [TltInputDecoration.collapsed].
//   final bool? isCollapsed;
...
//   ///
//   /// When [TltInputDecorator.isHovering] is true, the [hoverColor] is also blended
...
//   /// [TltInputDecorationTheme.fillColor].
//   ///
//   /// {@macro flutter.material.input_decorator.container_description}
//   final Color? fillColor;
...
//   /// [TltInputDecorationTheme.focusColor].
//   ///
...
//   ///
//   /// If [filled] is false, and [TltInputDecorator.isFocused] is false, the color
...
//   /// The border to display when the [TltInputDecorator] does not have the focus and
//   /// is showing an error.
//   ///
//   /// See also:
//   ///
//   ///  * [TltInputDecorator.isFocused], which is true if the [TltInputDecorator]'s child
//   ///    has the focus.
//   ///  * [TltInputDecoration.errorText], the error shown by the [TltInputDecorator], if non-null.
//   ///  * [border], for a description of where the [TltInputDecorator] border appears.
//   ///  * [UnderlineInputBorder], an [TltInputDecorator] border which draws a horizontal
//   ///    line at the bottom of the input decorator's container.
//   ///  * [OutlineInputBorder], an [TltInputDecorator] border which draws a
//   ///    rounded rectangle around the input decorator's container.
//   ///  * [InputBorder.none], which doesn't draw a border.
//   ///  * [focusedBorder], displayed when [TltInputDecorator.isFocused] is true
//   ///    and [TltInputDecoration.errorText] is null.
//   ///  * [focusedErrorBorder], displayed when [TltInputDecorator.isFocused] is true
//   ///    and [TltInputDecoration.errorText] is non-null.
//   ///  * [disabledBorder], displayed when [TltInputDecoration.enabled] is false
//   ///    and [TltInputDecoration.errorText] is null.
//   ///  * [enabledBorder], displayed when [TltInputDecoration.enabled] is true
//   ///    and [TltInputDecoration.errorText] is null.
//   final InputBorder? errorBorder;

//   /// The border to display when the [TltInputDecorator] has the focus and is not
//   /// showing an error.
//   ///
//   /// See also:
//   ///
...
//   ///    rounded rectangle around the input decorator's container.
//   ///  * [InputBorder.none], which doesn't draw a border.
//   ///  * [errorBorder], displayed when [TltInputDecorator.isFocused] is false
//   ///    and [TltInputDecoration.errorText] is non-null.
//   ///  * [focusedErrorBorder], displayed when [TltInputDecorator.isFocused] is true
//   ///    and [TltInputDecoration.errorText] is non-null.
//   ///  * [disabledBorder], displayed when [TltInputDecoration.enabled] is false
...
//   /// The border to display when the [TltInputDecorator] has the focus and is
//   /// showing an error.
//   ///
//   /// See also:
//   ///
...
//   /// The border to display when the [TltInputDecorator] is disabled and is not
//   /// showing an error.
//   ///
//   /// See also:
//   ///
//   ///  * [TltInputDecoration.enabled], which is false if the [TltInputDecorator] is disabled.
//   ///  * [TltInputDecoration.errorText], the error shown by the [TltInputDecorator], if non-null.
//   ///  * [border], for a description of where the [TltInputDecorator] border appears.
//   ///  * [UnderlineInputBorder], an [TltInputDecorator] border which draws a horizontal
//   ///    line at the bottom of the input decorator's container.
...
//   /// The border to display when the [TltInputDecorator] is enabled and is not
//   /// showing an error.
//   ///
//   /// See also:
//   ///
...
//   /// The decoration's container is the area which is filled if [filled] is
//   /// true and bordered per the [border]. It's the area adjacent to
//   /// [TltInputDecoration.icon] and above the widgets that contain
//   /// [TltInputDecoration.helperText], [TltInputDecoration.errorText], and
//   /// [TltInputDecoration.counterText].
//   ///
...
//   /// configured by the TltInputDecorator, depending on the values of
//   /// [TltInputDecoration.errorText], [TltInputDecoration.enabled],
//   /// [TltInputDecorator.isFocused] and the current [Theme].
//   ///
//   /// Typically one of [UnderlineInputBorder] or [OutlineInputBorder].
//   /// If null, TltInputDecorator's default is `const UnderlineInputBorder()`.
//   ///
//   /// See also:
//   ///
//   ///  * [InputBorder.none], which doesn't draw a border.
...
//   /// Typically set to true when the [TltInputDecorator] contains a multiline
...
//   /// Defines minimum and maximum sizes for the [TltInputDecorator].
//   ///
...
//   /// [TltInputDecorationTheme.constraints] will be used. If that
...
//   /// Used by widgets like [TextField] and [TltInputDecorator] to create a new
//   /// [TltInputDecoration] with default values taken from the [theme].
//   ///
//   /// Only null valued properties from this [TltInputDecoration] are replaced
//   /// by the corresponding values from [theme].
//   TltInputDecoration applyDefaults(TltInputDecorationTheme theme) {
//     return copyWith(
...
/// Defines the default appearance of [TltInputDecorator]s.
///
/// This class is used to define the value of [ThemeData.inputDecorationTheme].
/// The [TltInputDecorator], [TextField], and [TextFormField] widgets use
/// the current input decoration theme to initialize null [TltInputDecoration]
/// properties.
///
/// The [TltInputDecoration.applyDefaults] method is used to combine a input
/// decoration theme with an [TltInputDecoration] object.
@immutable
class TltInputDecorationTheme with Diagnosticable {
  /// Creates a value for [ThemeData.inputDecorationTheme] that
  /// defines default values for [TltInputDecorator].
  const TltInputDecorationTheme({
    this.labelStyle,
    this.floatingLabelStyle,
    this.helperStyle,
    this.helperMaxLines,
  ...
  /// The style to use for [TltInputDecoration.helperText].
  ///
  /// If [helperStyle] is a [MaterialStateTextStyle], then the effective
  /// text style can depend on the [MaterialState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// The maximum number of lines the [TltInputDecoration.helperText] can occupy.
  ///
  /// Defaults to null, which means that the [TltInputDecoration.helperText] will
  ...
  /// See also:
  ///
  ///  * [errorMaxLines], the equivalent but for the [TltInputDecoration.errorText].
  final int? helperMaxLines;

  /// The style to use for the [TltInputDecoration.hintText].
  ///
  /// If [hintStyle] is a [MaterialStateTextStyle], then the effective
  /// text style can depend on the [MaterialState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ///
  /// Also used for the [TltInputDecoration.labelText] when the
  /// [TltInputDecoration.labelText] is displayed on top of the input field (i.e.,
  ...
  /// The duration of the [TltInputDecoration.hintText] fade in and fade out animations.
  final Duration? hintFadeDuration;

  /// {@macro flutter.material.inputDecoration.errorStyle}
  final TextStyle? errorStyle;

  /// The maximum number of lines the [TltInputDecoration.errorText] can occupy.
  ///
  /// Defaults to null, which means that the [TltInputDecoration.errorText] will be
  ...
  /// See also:
  ///
  ///  * [helperMaxLines], the equivalent but for the [TltInputDecoration.helperText].
  final int? errorMaxLines;
  ...
  /// [TltInputDecoration.filled] is true and bordered per the [border].
  /// It's the area adjacent to [TltInputDecoration.icon] and above the
  /// [TltInputDecoration.icon] and above the widgets that contain
  /// [TltInputDecoration.helperText], [TltInputDecoration.errorText], and
  /// [TltInputDecoration.counterText].
  ///
  ...
  /// Whether the decoration is the same size as the input field.
  ///
  /// A collapsed decoration cannot have [TltInputDecoration.labelText],
  /// [TltInputDecoration.errorText], or an [TltInputDecoration.icon].
  final bool isCollapsed;

  /// The Color to use for the [TltInputDecoration.icon].
  ///
  /// If [iconColor] is a [MaterialStateColor], then the effective
  /// color can depend on the [MaterialState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// The style to use for the [TltInputDecoration.prefixText].
  ///
  /// If [prefixStyle] is a [MaterialStateTextStyle], then the effective
  /// text style can depend on the [MaterialState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// The Color to use for the [TltInputDecoration.prefixIcon].
  ///
  /// If [prefixIconColor] is a [MaterialStateColor], then the effective
  /// color can depend on the [MaterialState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// The style to use for the [TltInputDecoration.suffixText].
  ///
  ...
  /// The Color to use for the [TltInputDecoration.suffixIcon].
  ///
  /// If [suffixIconColor] is a [MaterialStateColor], then the effective
  /// color can depend on the [MaterialState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// The style to use for the [TltInputDecoration.counterText].
  ///
  /// If [counterStyle] is a [MaterialStateTextStyle], then the effective
  /// text style can depend on the [MaterialState.focused] state, i.e.
  /// if the [TextField] is focused or not.
  ...
  /// See also:
  ///
  ///  * [TltInputDecoration.constraints], which can override this setting for a
  ///    given decorator.
  final BoxConstraints? constraints;

  /// Creates a copy of this object but with the given fields replaced with the
  /// new values.
  TltInputDecorationTheme copyWith({
    TextStyle? labelStyle,
    TextStyle? floatingLabelStyle,
    TextStyle? helperStyle,
    int? helperMaxLines,
    ...
    return TltInputDecorationTheme(
      labelStyle: labelStyle ?? this.labelStyle,
      floatingLabelStyle: floatingLabelStyle ?? this.floatingLabelStyle,
      helperStyle: helperStyle ?? this.helperStyle,
      helperMaxLines: helperMaxLines ?? this.helperMaxLines,
  ...
  /// Returns a copy of this TltInputDecorationTheme where the non-null fields in
  /// the given TltInputDecorationTheme override the corresponding nullable fields
  /// in this TltInputDecorationTheme.
  ///
  /// The non-nullable fields of TltInputDecorationTheme, such as [floatingLabelBehavior],
  /// [isDense], [isCollapsed], [filled], and [alignLabelWithHint] cannot be overridden.
  ///
  /// In other words, the fields of the provided [TltInputDecorationTheme] are used to
  /// fill in the unspecified and nullable fields of this TltInputDecorationTheme.
  TltInputDecorationTheme merge(TltInputDecorationTheme? inputDecorationTheme) {
  ...
  bool operator ==(Object other) {
    ...
    return other is TltInputDecorationTheme &&
        other.labelStyle == labelStyle &&
        other.floatingLabelStyle == floatingLabelStyle &&
        other.helperStyle == helperStyle &&
        other.helperMaxLines == helperMaxLines &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    const TltInputDecorationTheme defaultTheme = TltInputDecorationTheme();
...
class _TltInputDecoratorDefaultsM2 extends TltInputDecorationTheme {
  const _TltInputDecoratorDefaultsM2(this.context) : super();
...
// BEGIN GENERATED TOKEN PROPERTIES - TltInputDecorator
...
class _TltInputDecoratorDefaultsM3 extends TltInputDecorationTheme {
  _TltInputDecoratorDefaultsM3(this.context) : super();
...
// END GENERATED TOKEN PROPERTIES - TltInputDecorator
