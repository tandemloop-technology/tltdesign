...
//   final double left;
//   isRTL ? left = size.width - width - x : left = x;
//   canvas.drawRect(Offset(left, 0.0) & Size(width, size.height), _paintLine);
// }

// if (progress != null) {
//   drawBar(0.0, progress.clamp(0.0, 1.0) * size.width);
// } else {
//   final double x1 = size.width * line1Tail.transform(progress);
//   final double width1 = size.width * line1Head.transform(progress) - x1;

//   final double x2 = size.width * line2Tail.transform(progress);
//   final double width2 = size.width * line2Head.transform(progress) - x2;
