...
class TltCustomPagination extends StatefulWidget {
  ...
  @override
  State<TltCustomPagination> createState() => _TltPaginationState();
}

class _TltPaginationState extends State<TltCustomPagination> {
...
class _NavButton extends StatelessWidget {
  ...
  final TltCustomPagination widget;
  final String text;
  final IconData icon;
